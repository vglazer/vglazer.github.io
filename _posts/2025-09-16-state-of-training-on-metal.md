...
- I didn't run CPU training to completion, but based on the 1st 50 iterations MPS training without `torch.compile` is almost an order of magnitude faster than CPU training (221ms vs 1986ms). This is great!
