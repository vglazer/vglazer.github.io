...
- For the time being, it seems that if you want first-class Metal support for training, including jit compilation, MLX (Apple-only) and tinygrad (Cross-platform) are your best options.
