...
* For a more involved example demonstrating Mojo language constructs such as [Lists](https://docs.modular.com/mojo/manual/get-started/#4-use-mojo-int-and-list-types-to-represent-the-game-state), [structs and modules](https://docs.modular.com/mojo/manual/get-started/#6-create-a-module-and-define-a-custom-type), as well as [calling Python from Mojo](https://docs.modular.com/mojo/manual/get-started/#13-import-and-use-a-python-package), `cd examples/mojo/life` and `pixi run mojo run lifev3.mojo` (this is just the example from [Get started with Mojo](https://docs.modular.com/mojo/manual/get-started)).
