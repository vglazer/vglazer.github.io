...
* For a more involved example demonstrating Mojo language constructs such as Lists, structs and modules, as well as calling Python from Mojo, `cd examples/mojo/life` and `pixi run mojo run lifev3.mojo` (this is just the example from [Get started with Mojo](https://docs.modular.com/mojo/manual/get-started)).
