...
* Once Python interop becomes [more mature](https://docs.modular.com/mojo/manual/python/mojo-from-python#known-limitations), Mojo should be a good choice for [accelearating performance-critical Python code](https://docs.modular.com/mojo/manual/python/mojo-from-python).
